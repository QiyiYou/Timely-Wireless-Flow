            ...
            for aa=1:obj.n_action
                ...
                for next_ss=1:obj.n_state
                    ...
                    if(ii==obj.period_lcm)
                        temp_val = temp_val + dual_lambda(obj.period_lcm, next_ss, tt)*obj.getTransitionProbability(ii+obj.period_lcm, ss,aa,next_ss);
                    else
                ...
                %distingush slot 1
                if(ii == 1)
                    temp_val = temp_val - dual_lambda(obj.period_lcm, ss, tt);
                else
