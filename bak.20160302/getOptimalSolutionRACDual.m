function [optimal_nu, optimal_lambda, optimal_utility] = getOptimalSolutionRACDual(obj, utility_coeff, utility_form)
% use the dual of RAC formulation (Proposition 4 in Mobihoc 2015) to get the
