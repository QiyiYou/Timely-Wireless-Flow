...
filePath = sprintf('fig/policies_comparsion_fig1_infocom/n_flow=%d',n_flow);
fileID = fopen(sprintf('%s/conf_policies_comparsion_fig1_infocom.txt',filePath),'w');
...
save(sprintf('%s/policies_comparsion_fig1_infocom.mat',filePath));
fclose(fileID);
%load('fig/policies_comparsion_fig1_infocom/n_flow=2/policies_comparsion_fig1_infocom.mat');
...
%     print(sprintf('%s/comparision_scheduling_flow_%d',filePath, nn),'-depsc');
    export_fig(sprintf('%s/fig1_infocom_flow_%d',filePath, nn), '-pdf','-transparent','-nocrop');
    export_fig(sprintf('%s/fig1_infocom_flow_%d',filePath, nn), '-eps','-transparent','-nocrop');
end
