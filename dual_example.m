...
fprintf(fileID, '\nFinish getFullDualApproxDistributedSolution with time %f seconds\n', toc);
...
fprintf(fileID, '\nFinish fullDualSchedule-Approx with time %f seconds\n', toc);
...
fprintf(fileID, '\nFinish halfDualApproxSchedule with time %f seconds\n', toc);
