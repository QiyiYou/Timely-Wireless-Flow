function [optimal_policy, optimal_action_distribution, status] = getApproximateSolutionRAC_given_rate(obj, given_throughput_per_flow)
% Here we given the timely throughput requirements for each flow and thus
% we should solve a feasiblity problem, see (P5) in the paper
%    max 1
%    s.t. (13a)-(13f)
%    var. z
...
cvx_begin
    ...
    for tt=1:obj.period_lcm
        ...
        for kk=1:obj.n_flow
            ...
            %r(kk) <= reward_temp;
            given_throughput_per_flow(kk) <= reward_temp;
        end
