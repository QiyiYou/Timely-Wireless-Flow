...
fprintf(fileID, '\nFinish getOptimalSolutionRACFromFlowInstance_CVX with time %f seconds\n', toc);
...
fprintf(fileID, '\nFinish getApproximateSolutionRACFromFlowInstance_CVX with time %f seconds\n', toc);
...
%    plot(1:T,cummean_successful_transmission_RAC_approx(nn,:), '-g', 'Linewidth', line_width);
