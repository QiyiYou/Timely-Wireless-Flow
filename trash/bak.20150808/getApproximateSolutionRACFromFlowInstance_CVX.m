function [optimal_policy, optimal_action_distribution, optimal_utility, optimal_throughput_per_flow] = getApproximateSolutionRACFromFlowInstance_CVX(obj, utility_coeff, utility_form)
