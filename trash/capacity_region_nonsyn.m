...
filePath = sprintf('fig/capacity_region/nonsyn/n_flow=%d',n_flow);
fileID = fopen(sprintf('%s/conf_capacity_region_nonsyn.txt',filePath),'w');
...
save(sprintf('%s/capacity_region_nonsyn.mat',filePath));
...
export_fig(sprintf('%s/capacity_regin_nonsyn', filePath), '-pdf','-transparent','-nocrop');
export_fig(sprintf('%s/capacity_regin_nonsyn', filePath), '-eps','-transparent','-nocrop');
