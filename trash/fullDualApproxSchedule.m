function [successful_transmission, ...
    ...
    = fullDualApproxSchedule(obj, T, optimal_policy_full_dual)
...
%Note that we use the non-vectorized version
...
for tt=1:T
    ...
    for aa=1:obj.n_action
        action_prob(aa) = optimal_policy_full_dual(obj.getFirstPeriodSlot(tt), current_state, aa, end);
    end
