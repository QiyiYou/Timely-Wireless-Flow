function [optimal_policy, optimal_utility, optimal_throughput_per_flow] = getOptimalSolutionRAC_CVX_Inequality(obj, utility_coeff, utility_form)
...
% the same as the function getOptimalSolutionRAC_CVX, excepte that we
% replace the equality by inequality for the state-distribution evolution.
